  ...
  return (
    <section id="estimates" className="bg-sky-brand py-12 md:py-32 px-4 sm:px-8 md:px-10 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
        ...
        {/* Right Side: Copy & Content - Left aligned on Mobile */}
        <div className="lg:col-span-6 space-y-6 md:space-y-8 text-left">
          <div>
            ...
            <p className="text-maroon-brand/90 font-medium text-sm xs:text-base md:text-xl leading-relaxed max-w-xl mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8 max-w-md">
              {['Detailed space measurements', 'Zero hidden costs', 'Fast 24-hour turnaround', 'Obligation-free advice'].map((item, idx) => (
                <div key={idx} className="flex items-center gap-2.5 text-maroon-brand font-semibold text-xs sm:text-base">
