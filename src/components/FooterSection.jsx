...
export default function FooterSection() {
  return (
    <footer className="relative bg-teal-darkroom text-white min-h-[85vh] flex flex-col justify-between overflow-hidden">
      ...
      {/* Main Footer Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 w-full py-20 sm:py-28 flex-1 flex flex-col justify-between">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          {/* Left Column Text Copy */}
          <div className="lg:col-span-7 space-y-6">
            <h2 className="font-display font-extrabold text-4xl sm:text-6xl text-white leading-tight tracking-tight">
              Let’s talk about <br />
              your project
            </h2>

            <p className="text-white/90 font-medium text-lg sm:text-xl leading-relaxed max-w-xl">
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-white/90 text-base sm:text-lg leading-relaxed flex items-start gap-3">
                <MapPin className="w-5 h-5 text-pink-brand shrink-0 mt-1" />
                <span>123 Anywhere St. Any City, State, Any Country</span>
              </p>
              <p className="text-white/90 text-base sm:text-lg flex items-center gap-3">
                <Phone className="w-5 h-5 text-pink-brand shrink-0" />
                <a href="tel:1234567890" className="hover:text-pink-brand transition-colors">
                  (123) 456 7890
                </a>
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-white/90 text-lg flex items-center gap-3">
                ...
                <a href="mailto:hello@reallygreatsite.com" className="hover:text-pink-brand transition-colors font-medium">
        ...
        <div className="pt-16 mt-16 border-t border-white/15 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
          <div className="font-display font-black text-4xl sm:text-6xl text-white tracking-tighter uppercase leading-none select-none">
            NEST <br />
            WALLPAPERS
          </div>
