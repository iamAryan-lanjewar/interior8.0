    ...
    <section id="contact" className="bg-sky-brand py-12 md:py-32 px-4 sm:px-8 md:px-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
        ...
        <div className="lg:col-span-5 space-y-4 md:space-y-6 text-left">
          ...
          <p className="text-maroon-brand/90 font-medium text-sm xs:text-base md:text-xl leading-relaxed">
          ...
          <div className="pt-2 md:pt-4 space-y-2.5 text-maroon-brand/85 font-semibold text-xs sm:text-sm">
